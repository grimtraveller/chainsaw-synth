...
#define JucePlugin_Name                 "Chainsaw"
#define JucePlugin_Desc                 "Chainsaw Synthesizer"
#define JucePlugin_Manufacturer         "SVA"
#define JucePlugin_ManufacturerCode     'SVA'
#define JucePlugin_PluginCode           'svachsw'
